...
| BS-contract Pass B2 (safety second-reject) | in flight | router-level standing-position refusal + `BundleSubmission.safety` |
| BS-contract Pass C / BS-universe → CR-8 | — | NOT STARTED |
