...
round — the user is away; decide and proceed per docs/research/HERMES.md rule 14/15, never stop to ask. The whole point
...
(Rounds Step 0). Read `CLAUDE.md` (behavioral base + Safety Rules) + `docs/research/HERMES.md` (Hermes protocol + governance rules 1–17) + `docs/research/gates.md` + the handoff prompt fully.
...
**The slice work (generator/evaluator split — docs/research/HERMES.md Generator/Evaluator split + rule 11):**
