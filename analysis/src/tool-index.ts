...
const CURATED: Record<string, Curated> = {
  ...
  "analysis:block-activity": meta("view", ["single-block", "production-events", "block-scan", "state-coverage"], "zero-cu", "Join one block's reconstructed coarse mids to its production funnel and block-scan evidence.", 90),
  ...
  "listener:searcher:historical-live-production-replay": meta(
    "replay",
    [
      "block-scan",
      "pinned-replay",
    ...
    "fork",
    "Run the real production entry against a canonical historical source or fully ordered same-block prefix without revealing a target route or amount.",
    110,
  ),
