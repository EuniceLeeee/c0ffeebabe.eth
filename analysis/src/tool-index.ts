...
const CURATED: Record<string, Curated> = {
  ...
  "listener:searcher:blockscan-hunt-tx149": meta("replay", ["block-scan", "pinned-replay", "production-stage"], "fork", "Trusted parent-block replay for a pinned production sample.", 100),
