...
- `HERMES.md` — the live-run collaboration runbook + governance rules 1–17. Read it
  when running a Hermes / handoff / autonomous round.
- `docs/gates.md` — the validation contract (rule 12: `fixed` vs `implemented`,
...
truth; read `HERMES.md` / `docs/gates.md` when the work is a live-run round or a
searcher-correctness change.

When changing project instructions, edit `CLAUDE.md` (or `HERMES.md`/`docs/gates.md`
