...
export const curvePlainManifest = {
  ...
  domain: "swap",
  ownedActionAdapterIds: ["curve-exchange", "curve-exchange-nr", "curve-exchange-plain", "curve-exchange-received-uint", "curve-exchange-uint"],
  ...
  edgeAdapterIds: ["curve-exchange", "curve-exchange-nr", "curve-exchange-plain", "curve-exchange-received-uint", "curve-exchange-uint"],
