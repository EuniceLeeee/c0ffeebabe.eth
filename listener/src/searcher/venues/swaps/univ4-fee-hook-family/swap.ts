...
/**
 * Same swap semantics as the standard univ4 Family (same manager, same
 * unlock/swap/take flow); the receipt observation binds the fee-hook owned
 * unlock adapter id.
 */
...
} satisfies SwapDomainSemantics<FeeHookDescriptor, FeeHookRoute>;
