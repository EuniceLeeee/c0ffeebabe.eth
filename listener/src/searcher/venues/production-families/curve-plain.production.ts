...
import { curvePlainReceivedAction, curvePlainNoReceiverAction, curvePlainRegularAction, curvePlainUintReceivedAction } from "../swaps/curve-plain-family/action.js";
...
export const plugin = defineSwapFamily({ manifest: curvePlainManifest, capture: curvePlainCapture,
  ...
  actionAdapters: [curvePlainReceivedAction, curvePlainNoReceiverAction, curvePlainRegularAction, curvePlainUintReceivedAction] });
