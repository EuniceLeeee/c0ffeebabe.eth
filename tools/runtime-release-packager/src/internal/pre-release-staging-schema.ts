...
export const PRE_RELEASE_STAGING_LAYOUT_V1 = Object.freeze({
  ...
  releaseAcceptanceSigningRequestPath: "/var/lib/aloha/pre-release/runtime/release-acceptance-signing-request.json",
  productionArtifactBaseRepositoryPath: "/var/lib/aloha/pre-release/runtime/production-artifact-bases",
  productionPackagingInputDirectory: "/var/lib/aloha/pre-release/package-inputs",
  productionDeploymentInfrastructureInputPath: "/var/lib/aloha/pre-release/package-inputs/deployment-runtime-infrastructure.json",
  productionRevmWorkerInputPath: "/var/lib/aloha/pre-release/package-inputs/aloha-revm-worker",
  productionProofSignerInputPath: "/var/lib/aloha/pre-release/package-inputs/aloha-proof-signer",
