...
export const EIGENPIE_HISTORY_SOURCE_PLAN_ID = "eigenpie.asset-deposit-rolling-observation" as const;
...
export const EIGENPIE_MANIFEST = Object.freeze({
  ...
  sourcePlans: Object.freeze([
    ...
    { id: EIGENPIE_HISTORY_SOURCE_PLAN_ID, historyStartBlock: null, evidenceChannel: "complete-denominator" as const },
  ]),
