...
import { FLUID_CREDIT_STAGE_DEFINITIONS } from "../src/runtime/definitions.ts";

test("Fluid Credit runtime output codecs are deeply immutable", () => {
  for (const definition of FLUID_CREDIT_STAGE_DEFINITIONS) {
