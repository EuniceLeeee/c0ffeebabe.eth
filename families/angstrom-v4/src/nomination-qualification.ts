...
export const ANGSTROM_V4_NOMINATION_INDEPENDENT_ORACLE = Object.freeze({ schemaVersion: 1, oracleRoot: hashDomain("aloha/angstrom-v4/nomination-independent-oracle/v1", ["pool-manager-initialize", "exact-hook-binding", "contiguous-history"]) });
