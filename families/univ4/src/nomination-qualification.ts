...
export const UNIV4_NOMINATION_INDEPENDENT_ORACLE = Object.freeze({ schemaVersion: 1, oracleRoot: hashDomain("aloha/univ4/nomination-independent-oracle/v1", ["pool-manager-initialize", "pool-key-domain", "rolling-observation"]) });
