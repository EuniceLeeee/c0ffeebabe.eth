...
const definitionInput: FamilyAuthoringDefinitionV1 = {
  ...
  runtimeAdapters: { "search/v1": { modulePath: `${moduleRoot}/search-adapter.ts`, exportName: "UNIV3_SEARCH_RUNTIME_ADAPTER_FACTORY", capabilityIds: { state: asCapabilityId(UNIV3_CAPABILITY_IDS.state), coarse: asCapabilityId(UNIV3_CAPABILITY_IDS.coarse), exact: asCapabilityId(UNIV3_CAPABILITY_IDS.exact) }, actionOwnerIds: { swap: UNIV3_ACTION_OWNER_ID } } },
