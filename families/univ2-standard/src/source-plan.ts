...
export const UNIV2_STANDARD_HISTORY_SOURCE_PLAN_ID = "univ2-standard.pair-created-contiguous-history" as const;
...
export const UNIV2_STANDARD_HISTORY_SOURCE_PLAN_DEFINITION = defineFamilySourcePlan({ sourcePlanId: UNIV2_STANDARD_HISTORY_SOURCE_PLAN_ID, completeness: "contiguous-history", historyStartBlock: "0", schemaHash: UNIV2_STANDARD_HISTORY_SOURCE_PLAN_SCHEMA_HASH });
