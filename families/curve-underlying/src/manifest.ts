...
export const CURVE_UNDERLYING_REGISTRY_SOURCE_PLAN_ID = "curve-underlying.degraded-recent-observation" as const;
...
export const CURVE_UNDERLYING_I128_GET_DY_SELECTOR = "0x07211ef7" as const;
export const CURVE_UNDERLYING_UINT_GET_DY_SELECTOR = "0x85f11d1e" as const;
